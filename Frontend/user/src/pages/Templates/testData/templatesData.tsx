export const featureData = [
  ...
  export const techniqueData = [
    ...
    },
    {
      ...
      description: 'From "to do" to "done", Trello\'s scrum board template helps your software development team use the popular agile framework to finish work faster.',
  ...
  export const pmData = [
    ...
    },
    {
      ...
      author: 'UNICEF',
      description: 'Working with any number of countries at any given time, UNICEF is able to keep track of every location, including all points of contact and every important document, on dedicated Trello boards.',
      favoriteCount: '3.2N',
