  ...
  return (
    <div className="detail-card-container w-full">
        <div className="features">
            <div className="title-container flex justify-between items-center">
                ...
                <div className="search-container relative">
                    <input className="max-w-240px relative box-border bg-white border border-gray-300 h-10 min-w-240px rounded-md px-8" id="inputSearch" placeholder="Search"></input>
                    <span className="search-icon absolute top-1/2 right-10 transform -translate-y-1/2 pointer-events-none">
        ...
        <div className="newTemplate">
            <div className="title flex items-center flex items-center">
                <img className="inline-block h-6 w-6 min-w-6 mr-3 rounded-md" src="https://trello.com/assets/32ad10f52fc078a76ea4.svg" width="24px" height="24px"></img>
            ...
            <div className="detail-newTemplate flex flex-wrap mt-5 w-full justify-starts">
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">New Hire Onboarding</label>
                        <p className="content text-sm leading-6 text-gray-600">by Trello Team</p>
                        <p className="content text-sm leading-6 text-gray-600">Help new employees start strong with this onboarding template</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                            <ContentCopyOutlinedIcon fontSize="small"/>18.3N
                        </button>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="share">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 mr-3/100 mr-3">
                    ...
                    <CardContent>
                        ...
                        <p className="content text-sm leading-6 text-gray-600">Use this template to create a tier list for anything you want. A tier list is a way to rank items in a category from best to worst. This could be: best NBA players, GOAT’d pasta dishes, and tastiest fast food joints.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Better Work Habits Challenge</label>
                        <p className="content text-sm leading-6 text-gray-600">by Trello Team</p>
                        <p className="content text-sm leading-6 text-gray-600">Track, reflect, and celebrate new effective habits that you want to build at work.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
        ...
        <div className="business">
            ...
            <div className="detail-newTemplate flex  flex-wrap mt-5 w-full justify-start">
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3 border-0">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">A Lead Management Pipeline by Crmble</label>
                        <p className="content text-sm leading-6 text-gray-600">by Toni, Founder @ Crmble</p>
                        <p className="content text-sm leading-6 text-gray-600">Use this board to manage inventory or swag requests with the Crmble Power-Up!</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        ...
                        <p className="content text-sm leading-6 text-gray-600">Lean Canvas is a 1-page business plan template created by Ash Maurya that helps you deconstruct your idea into its key assumptions. </p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Nonprofit Project Management</label>
                        <p className="content text-sm leading-6 text-gray-600">by Atlassian</p>
                        <p className="content text-sm leading-6 text-gray-600">Turn big dreams into bigger results. Use this Trello template to build your nonprofit team's ideal workflow, for projects big or small.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
        ...
        <div className="design">
            ...
            <div className="detail-newTemplate flex  flex-wrap mt-5 w-full justify-start">
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Design Project Template</label>
                        <p className="content text-sm leading-6 text-gray-600">by Kene Ohiaeri, Product Designer</p>
                        <p className="content text-sm leading-6 text-gray-600">An easy to use template for planning and monitoring your branding and product design projects online.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Design System Checklist</label>
                        <p className="content text-sm leading-6 text-gray-600">by Rahul JR, Senior Product Manager @ Zoho Corp</p>
                        <p className="content text-sm leading-6 text-gray-600">A design system unites product teams around a common visual language.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Freelance Branding Project</label>
                        <p className="content text-sm leading-6 text-gray-600">by Stu Smith, Designer @ Trello</p>
                        <p className="content text-sm leading-6 text-gray-600">Use this template to run your next Branding project. </p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
        ...
        <div className="education">
            ...
            <div className="detail-newTemplate flex  flex-wrap mt-5 w-full justify-start">
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Remote Class Template</label>
                        <p className="content text-sm leading-6 text-gray-600">by Kelly Theisen, Assistant Professor of Chemistry</p>
                        <p className="content text-sm leading-6 text-gray-600">Stay organized in a remote learning environment.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Academic Literature Review</label>
                        <p className="content text-sm leading-6 text-gray-600">by Ann Gillian Chu, PhD researcher @ the University of St. Andrews</p>
                        <p className="content text-sm leading-6 text-gray-600">Keep track of what you've read and your notes in one place for long writing projects, like dissertations.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Teaching: Weekly Planning</label>
                        <p className="content text-sm leading-6 text-gray-600">bt Emma Trentman, Associate Professor of Arabic @ University of New Mexico</p>
                        <p className="content text-sm leading-6 text-gray-600">A board per class. The lists are the weeks of the semester, cards are things I need to do for class each week.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
        ...
        <div className="technique">
            ...
            <div className="detail-newTemplate flex  flex-wrap mt-5 w-full justify-start">
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Kanban Template</label>
                        <p className="content text-sm leading-6 text-gray-600">by Trello Engineering Team</p>
                        <p className="content text-sm leading-6 text-gray-600">Use this simple Kanban template to improve the productivity of your engineering team and help them build better products, faster.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        ...
                        <p className="content text-sm leading-6 text-gray-600">by Robin Warren, Founder of Cherry Wood Software</p>
                        <p className="content text-sm leading-6 text-gray-600">From &quot;to do&quot; to &quot;done&quot;, Trello's scrum board template helps your software development team use the popular agile framework to finish work faster.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Software Development [Web App, iOS App, Android App]</label>
                        <p className="content text-sm leading-6 text-gray-600">by iLyas Farawe, CTO @ Techbarn</p>
                        <p className="content text-sm leading-6 text-gray-600">Manage tasks and deadlines for software development projects.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
        ...
        <div className="Marketing">
            <div className="title flex items-center mb-6 mt-6">
                <img className="inline-block h-6 w-6 min-w-6 mr-3 rounded-md" src="https://trello.com/assets/3695bf4ae87a54c23f88.svg" width="24px" height="24px"></img>
            ...
            <div className="detail-newTemplate flex  flex-wrap mt-5 w-full justify-start">
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Speaker guide for online events</label>
                        <p className="content text-sm leading-6 text-gray-600">by Josip Lisec, Head of Product @ SpotMe</p>
                        <p className="content text-sm leading-6 text-gray-600">Prep for your next virtual event with precision! </p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Marketing Content Catalog</label>
                        <p className="content text-sm leading-6 text-gray-600">by Nicholas Bouchard, Content Marketer @ Unito</p>
                        <p className="content text-sm leading-6 text-gray-600">Centralize all the content your marketing teams create and make it easily searchable.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Marketing Overview</label>
                        <p className="content text-sm leading-6 text-gray-600">by Stella Garber, Head of Marketing @ Trello</p>
                        <p className="content text-sm leading-6 text-gray-600">Use this board to create a stronger sense of transparency within your marketing team and the company.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
        ...
        <div className="projectManagement">
            ...
            <div className="detail-newTemplate flex  flex-wrap mt-5 w-full justify-start">
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Client Workflow Management</label>
                        <p className="content text-sm leading-6 text-gray-600">by Jordan L. Couch, Attorney @ Palace Law</p>
                        <p className="content text-sm leading-6 text-gray-600">Use a Trello board to go paperless while managing a client workflow.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">UNICEF Global Innovation Centres</label>
                        <p className="content text-sm leading-6 text-gray-600">by UNICEF</p>
                        <p className="content text-sm leading-6 text-gray-600">Working with any number of countries at any given time, UNICEF is able to keep track of every location, including all points of contact and every important document, on dedicated Trello boards.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Advanced Project Budgeting and Time Tracking</label>
                        <p className="content text-sm leading-6 text-gray-600">by Vitaly Andrianov, Maker of SmartFields for Trello Power-Up</p>
                        <p className="content text-sm leading-6 text-gray-600">Track time and budget for your projects with ease and less manual work.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
        ...
        <div className="workRemotely">
            ...
            <div className="detail-newTemplate flex  flex-wrap mt-5 w-full justify-start">
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Work From Home Daily Planner</label>
                        <p className="content text-sm leading-6 text-gray-600">by Sarah Costello @ TalentHub</p>
                        <p className="content text-sm leading-6 text-gray-600">Plan, collaborate and monitor your work-from-home schedule.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Mr. Rogers: “Watercooler” Video Chat Planner</label>
                        <p className="content text-sm leading-6 text-gray-600">by Trello Team</p>
                ...
                <Card variant="elevation" elevation={0} className="item-newTemplate min-h-100 w-full md:w-72 max-w-sm mr-3/100 mr-3">
                    ...
                    <CardContent>
                        <label className="content-title flex items-center text-base font-bold text-gray-700">Remote Team Hub</label>
                        <p className="content text-sm leading-6 text-gray-600">by Trello Team	</p>
                        <p className="content text-sm leading-6 text-gray-600">A mission control center for your team productivity.</p>
                    </CardContent>
                    <CardActions disableSpacing>
                        <button className="icon inline-flex text-sm text-gray-600 h-5 mr-5" aria-label="add to favorites">
