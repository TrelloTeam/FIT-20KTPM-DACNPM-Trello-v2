export const lists = [
  {
    ...
    order: 1,
    data: [
      { id: 'task1', list_id: 'list1', order: 1, name: 'Task 1', list_name: 'todo', watcher_email: ['email1','email2'] },
  ...
  },
  {
    ...
    board_id: 1,
    order: 3,
    data: [{ id: 'task4', list_id: 'list3', order: 1, name: 'Task 4', list_name: 'done', watcher_email: [] }]
  }
]
